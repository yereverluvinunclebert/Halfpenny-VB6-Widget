...
Begin VB.Form menuForm 
   ...
   Begin VB.Menu mnuMainMenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About Halfpenny Cairo widget"
      End
      ...
      Begin VB.Menu mnuHelpSplash 
         Caption         =   "Halfpenny One-Page Help"
      End
...
Public Sub mnuLatest_Click()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Halfpenny-VB6-Widget/raw/main/Setup.exe", vbNullString, App.Path, 1)
    End If
