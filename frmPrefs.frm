...
Begin VB.Form halfpennyPrefs 
   AutoRedraw      =   -1  'True
   Caption         =   "Halfpenny Preferences"
   ClientHeight    =   10650
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8970
   ...
   End
End
Attribute VB_Name = "halfpennyPrefs"
...
chkShowTaskbar_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkShowTaskbar_Click of Form halfpennyPrefs"
End Sub
...
Form_Load_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_Load of Form halfpennyPrefs"
...
btnAboutDebugInfo_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnAboutDebugInfo_Click of form halfpennyPrefs"
End Sub
...
btnDonate_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnDonate_Click of Form halfpennyPrefs"
End Sub
...
btnFacebook_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnFacebook_Click of Form halfpennyPrefs"
End Sub
...
btnOpenFile_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnOpenFile_Click of Form halfpennyPrefs"
            Resume Next
          End If
    End With
End Sub
...
btnUpdate_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnUpdate_Click of Form halfpennyPrefs"
End Sub
...
btnDefaultEditor_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnDefaultEditor_Click of Form halfpennyPrefs"
            Resume Next
          End If
    End With
...
chkEnableBalloonTooltips_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkEnableBalloonTooltips_Click of Form halfpennyPrefs"
End Sub
...
chkIgnoreMouse_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkIgnoreMouse_Click of Form halfpennyPrefs"
End Sub
...
chkPreventDragging_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkPreventDragging_Click of Form halfpennyPrefs"
            Resume Next
          End If
    End With
...
chkWidgetHidden_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkWidgetHidden_Click of Form halfpennyPrefs"
...
cmbAspectHidden_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmbAspectHidden_Click of Form halfpennyPrefs"
End Sub
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\halfpenny Widget VB6\halfpenny Widget.vbp"
...
cmbDebug_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmbDebug_Click of Form halfpennyPrefs"
            Resume Next
          End If
    End With
...
cmbScrollWheelDirection_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmbScrollWheelDirection_Click of Form halfpennyPrefs"
End Sub
...
cmbWidgetPosition_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmbWidgetPosition_Click of Form halfpennyPrefs"
            Resume Next
          End If
    End With
End Sub
...
IsVisible_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure IsVisible of Form halfpennyPrefs"
            Resume Next
          End If
    End With
End Property
...
showLastTab_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure showLastTab of Form halfpennyPrefs"
...
Private Sub positionPrefsFramesButtons()
    ...
    halfpennyPrefs.Width = rightHandAlignment + leftHandGutterWidth + 75 ' (not quite sure why we need the 75 twips padding)
...
'        halfpennyPrefs.Height = btnHelp.Top + btnHelp.Height + 600
'        lastFormHeight = halfpennyPrefs.Height
'    End If
...
positionPrefsFramesButtons_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure positionPrefsFramesButtons of Form halfpennyPrefs"
...
Private Sub btnCancel_Click()
   On Error GoTo btnCancel_Click_Error
    ...
    btnSave.Enabled = False ' disable the save button
    halfpennyPrefs.themeTimer.Enabled = False
...
btnCancel_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnCancel_Click of Form halfpennyPrefs"
End Sub
'
'---------------------------------------------------------------------------------------
...
Private Sub btnHelp_Click()
    ...
    On Error GoTo btnHelp_Click_Error
        ...
        Else
            MsgBox ("%Err-I-ErrorNumber 11 - The help file - halfpenny Help.html - is missing from the help folder.")
        End If
...
btnHelp_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnHelp_Click of Form halfpennyPrefs"
End Sub
'
'---------------------------------------------------------------------------------------
...
'    gblPlhLocationPercPrefValue
    ...
    If gblPlStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "HalfpennyWidget", """" & App.Path & "\" & "Halfpenny.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "HalfpennyWidget", vbNullString)
    End If
    ...
    If fFExists(gblPlSettingsFile) Then
        ...
        sPutINISetting softwareThingummy, "halfpennySelection", gblHalfpennySelection, gblPlSettingsFile
...
'        msgCnt = 0
    ...
    ' sets the characteristics of the halfpenny and menus immediately after saving
...
btnSave_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnSave_Click of Form halfpennyPrefs"
...
Private Sub btnPrefsFont_Click()
    ...
    Call changeFont(halfpennyPrefs, True, fntFont, fntSize, fntWeight, fntStyle, fntColour, fntItalics, fntUnderline, fntFontResult)
...
btnPrefsFont_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnPrefsFont_Click of Form halfpennyPrefs"
...
Private Sub adjustPrefsControls()
    ...
    If gblPlPrefsFont <> vbNullString Then
        Call changeFormFont(halfpennyPrefs, gblPlPrefsFont, Val(gblPlPrefsFontSize), fntWeight, fntStyle, gblPlPrefsFontItalics, gblPlPrefsFontColour)
    End If
...
adjustPrefsControls_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure adjustPrefsControls of Form halfpennyPrefs on line " & Erl
...
populatePrefsComboBoxes_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure populatePrefsComboBoxes of Form halfpennyPrefs"
            Resume Next
          End If
    End With
...
clearBorderStyle_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure clearBorderStyle of Form halfpennyPrefs"
...
Form_Resize_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_Resize of Form halfpennyPrefs"
            Resume Next
          End If
    End With
End Sub
...
Form_Unload_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Form_Unload of Form halfpennyPrefs"
End Sub
...
Private Sub fraConfigInner_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If gblPlEnableTooltips = "1" Then CreateToolTip fraConfigInner.hwnd, "The configuration panel is the location for optional configuration items. These items change how halfpenny operates, configure them to suit your needs and your mode of operation.", _
...
Private Sub fraConfig_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If gblPlEnableTooltips = "1" Then CreateToolTip fraConfig.hwnd, "The configuration panel is the location for optional configuration items. These items change how halfpenny operates, configure them to suit your needs and your mode of operation.", _
                  TTIconInfo, "Help on Configuration", , , , True
...
imgGeneral_Click_Error:
     ...
     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure imgGeneral_Click of Form halfpennyPrefs"
End Sub
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
       Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Halfpenny-VB6-Widget", vbNullString, App.Path, 1)
    End If
...
lblGitHub_dblClick_Error:
     ...
     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure lblGitHub_dblClick of Form halfpennyPrefs"
End Sub
...
txtAboutText_MouseDown_Error:
     ...
     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure txtAboutText_MouseDown of Form halfpennyPrefs"
End Sub
...
sliGaugeSize_Change_Error:
     ...
     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure sliGaugeSize_Change of Form halfpennyPrefs"
End Sub
...
sliOpacity_Change_Error:
     ...
     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure sliOpacity_Change of Form halfpennyPrefs"
End Sub
...
Public Sub setPrefsTooltips()
   ...
   On Error GoTo setPrefsTooltips_Error
    ...
    If gblPlEnableTooltips = "1" Then
        ...
        cmbScrollWheelDirection.ToolTipText = "To change the direction of the mouse scroll wheel when resiziing the halfpenny gauge."
        ...
        sliGaugeSize.ToolTipText = "Adjust to a percentage of the original size. Any adjustment in size takes place instantly (you can also use Ctrl+Mousewheel hovering over the halfpenny itself)."
        'sliWidgetSkew.ToolTipText = "Adjust to a degree skew of the original position. Any adjustment in direction takes place instantly (you can also use the Mousewheel hovering over the halfpenny itself."
    ...
    Else
        ...
        'cmbhalfpennySelection.ToolTipText = vbNullString
...
setPrefsTooltips_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure setPrefsTooltips of Form halfpennyPrefs"
...
DestroyToolTip_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure DestroyToolTip of Form halfpennyPrefs"
End Sub
'---------------------------------------------------------------------------------------
...
loadPrefsAboutText_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure loadPrefsAboutText of Form halfpennyPrefs"
...
Private Sub picButtonMouseUpEvent(ByVal thisTabName As String, ByRef thisPicName As Image, ByRef thisPicNameClicked As Image, ByRef thisFraName As Frame, Optional ByRef thisFraButtonName As Frame)
    ...
    If dynamicSizingFlg = False Then
        ...
        halfpennyPrefs.Height = lastFormHeight
    End If
...
picButtonMouseUpEvent_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure picButtonMouseUpEvent of Form halfpennyPrefs"
...
'
'    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure scrollFrameDownward of Form halfpennyPrefs"
'
'End Sub
...
themeTimer_Timer_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure themeTimer_Timer of Form halfpennyPrefs"
...
mnuCoffee_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuCoffee_Click of Form halfpennyPrefs"
End Sub
...
mnuLicenceA_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuLicenceA_Click of Form halfpennyPrefs"
            Resume Next
          End If
    End With
...
mnuSupport_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuSupport_Click of Form halfpennyPrefs"
End Sub
...
Private Sub mnuAuto_Click()
   ...
   On Error GoTo mnuAuto_Click_Error
    ...
    If halfpennyPrefs.themeTimer.Enabled = True Then
            MsgBox "Automatic Theme Selection is now Disabled"
            halfpennyPrefs.mnuAuto.Caption = "Auto Theme Disabled - Click to Enable"
            halfpennyPrefs.mnuAuto.Checked = False
    ...
    Else
            ...
            halfpennyPrefs.mnuAuto.Caption = "Auto Theme Enabled - Click to Disable"
            halfpennyPrefs.mnuAuto.Checked = True
            
            halfpennyPrefs.themeTimer.Enabled = True
            Call setThemeColour
    End If
...
mnuAuto_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuAuto_Click of Form halfpennyPrefs"
End Sub
...
Private Sub mnuDark_Click()
   On Error GoTo mnuDark_Click_Error
    ...
    halfpennyPrefs.mnuAuto.Caption = "Auto Theme Disabled - Click to Enable"
    halfpennyPrefs.mnuAuto.Checked = False
    halfpennyPrefs.mnuDark.Caption = "Dark Theme Enabled"
    halfpennyPrefs.mnuLight.Caption = "Light Theme Enable"
    halfpennyPrefs.themeTimer.Enabled = False
...
mnuDark_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuDark_Click of Form halfpennyPrefs"
End Sub
...
Private Sub mnuLight_Click()
   ...
   On Error GoTo mnuLight_Click_Error
    ...
    halfpennyPrefs.mnuAuto.Caption = "Auto Theme Disabled - Click to Enable"
    halfpennyPrefs.mnuAuto.Checked = False
    halfpennyPrefs.mnuDark.Caption = "Dark Theme Enable"
    halfpennyPrefs.mnuLight.Caption = "Light Theme Enabled"
    halfpennyPrefs.themeTimer.Enabled = False
...
mnuLight_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuLight_Click of Form halfpennyPrefs"
End Sub
...
Private Sub setThemeShade(ByVal redC As Integer, ByVal greenC As Integer, ByVal blueC As Integer)
    ...
    halfpennyPrefs.BackColor = RGB(redC, greenC, blueC)
    
    ' all buttons must be set to graphical
    For Each ctrl In halfpennyPrefs.Controls
    ...
    If redC = 212 Then
        'classicTheme = True
        halfpennyPrefs.mnuLight.Checked = False
        halfpennyPrefs.mnuDark.Checked = True
        
        Call setIconImagesDark
        
    Else
        'classicTheme = False
        halfpennyPrefs.mnuLight.Checked = True
        halfpennyPrefs.mnuDark.Checked = False
    ...
    'halfpennyPrefs.slihalfpennySelection.BackColor = RGB(redC, greenC, blueC)
    'halfpennyPrefs.'sliWidgetSkew.BackColor = RGB(redC, greenC, blueC)
    halfpennyPrefs.sliGaugeSize.BackColor = RGB(redC, greenC, blueC)
    halfpennyPrefs.sliOpacity.BackColor = RGB(redC, greenC, blueC)
    halfpennyPrefs.txtAboutText.BackColor = RGB(redC, greenC, blueC)
...
adjustPrefsTheme_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure adjustPrefsTheme of Form halfpennyPrefs"
...
Private Sub setModernThemeColours()
    ...
    'halfpennyPrefs.mnuAuto.Caption = "Auto Theme Selection Cannot be Enabled"
...
Private Sub loadHigherResImages()
    ...
    If halfpennyPrefs.mnuDark.Checked = True Then
        Call setIconImagesDark
    Else
        Call setIconImagesLight
    End If
...
loadHigherResImages_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure loadHigherResImages of Form halfpennyPrefs"
End Sub
'---------------------------------------------------------------------------------------
...
positionTimer_Timer_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure positionTimer_Timer of Form halfpennyPrefs"
End Sub
...
chkEnableResizing_Click_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure chkEnableResizing_Click of Form halfpennyPrefs"
...
setframeHeights_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure setframeHeights of Form halfpennyPrefs"
End Sub
...
Private Sub setIconImagesDark()
    ...
    If fFExists(resourcePath & "\config-icon-dark-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgConfig.Picture = LoadPicture(resourcePath & "\config-icon-dark-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\general-icon-dark-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgGeneral.Picture = LoadPicture(resourcePath & "\general-icon-dark-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\position-icon-dark-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgPosition.Picture = LoadPicture(resourcePath & "\position-icon-dark-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\font-icon-dark-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgFonts.Picture = LoadPicture(resourcePath & "\font-icon-dark-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\development-icon-dark-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgDevelopment.Picture = LoadPicture(resourcePath & "\development-icon-dark-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\sounds-icon-dark-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgSounds.Picture = LoadPicture(resourcePath & "\sounds-icon-dark-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\windows-icon-dark-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgWindow.Picture = LoadPicture(resourcePath & "\windows-icon-dark-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\about-icon-dark-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgAbout.Picture = LoadPicture(resourcePath & "\about-icon-dark-" & topIconWidth & ".jpg")
    
    ' I may yet create clicked versions of all the icons but not now!
    If fFExists(resourcePath & "\config-icon-dark-600-clicked.jpg") Then halfpennyPrefs.imgConfigClicked.Picture = LoadPicture(resourcePath & "\config-icon-dark-600-clicked.jpg")
    If fFExists(resourcePath & "\general-icon-dark-600-clicked.jpg") Then halfpennyPrefs.imgGeneralClicked.Picture = LoadPicture(resourcePath & "\general-icon-dark-600-clicked.jpg")
    If fFExists(resourcePath & "\position-icon-dark-600-clicked.jpg") Then halfpennyPrefs.imgPositionClicked.Picture = LoadPicture(resourcePath & "\position-icon-dark-600-clicked.jpg")
    If fFExists(resourcePath & "\font-icon-dark-600-clicked.jpg") Then halfpennyPrefs.imgFontsClicked.Picture = LoadPicture(resourcePath & "\font-icon-dark-600-clicked.jpg")
    If fFExists(resourcePath & "\development-icon-dark-600-clicked.jpg") Then halfpennyPrefs.imgDevelopmentClicked.Picture = LoadPicture(resourcePath & "\development-icon-dark-600-clicked.jpg")
    If fFExists(resourcePath & "\sounds-icon-dark-600-clicked.jpg") Then halfpennyPrefs.imgSoundsClicked.Picture = LoadPicture(resourcePath & "\sounds-icon-dark-600-clicked.jpg")
    If fFExists(resourcePath & "\windows-icon-dark-600-clicked.jpg") Then halfpennyPrefs.imgWindowClicked.Picture = LoadPicture(resourcePath & "\windows-icon-dark-600-clicked.jpg")
    If fFExists(resourcePath & "\about-icon-dark-600-clicked.jpg") Then halfpennyPrefs.imgAboutClicked.Picture = LoadPicture(resourcePath & "\about-icon-dark-600-clicked.jpg")
...
setIconImagesDark_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure setIconImagesDark of Form halfpennyPrefs"
...
Private Sub setIconImagesLight()
    ...
    If fFExists(resourcePath & "\config-icon-light-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgConfig.Picture = LoadPicture(resourcePath & "\config-icon-light-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\general-icon-light-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgGeneral.Picture = LoadPicture(resourcePath & "\general-icon-light-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\position-icon-light-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgPosition.Picture = LoadPicture(resourcePath & "\position-icon-light-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\font-icon-light-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgFonts.Picture = LoadPicture(resourcePath & "\font-icon-light-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\development-icon-light-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgDevelopment.Picture = LoadPicture(resourcePath & "\development-icon-light-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\sounds-icon-light-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgSounds.Picture = LoadPicture(resourcePath & "\sounds-icon-light-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\windows-icon-light-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgWindow.Picture = LoadPicture(resourcePath & "\windows-icon-light-" & topIconWidth & ".jpg")
    If fFExists(resourcePath & "\about-icon-light-" & topIconWidth & ".jpg") Then halfpennyPrefs.imgAbout.Picture = LoadPicture(resourcePath & "\about-icon-light-" & topIconWidth & ".jpg")
    
    ' I may yet create clicked versions of all the icons but not now!
    If fFExists(resourcePath & "\config-icon-light-600-clicked.jpg") Then halfpennyPrefs.imgConfigClicked.Picture = LoadPicture(resourcePath & "\config-icon-light-600-clicked.jpg")
    If fFExists(resourcePath & "\general-icon-light-600-clicked.jpg") Then halfpennyPrefs.imgGeneralClicked.Picture = LoadPicture(resourcePath & "\general-icon-light-600-clicked.jpg")
    If fFExists(resourcePath & "\position-icon-light-600-clicked.jpg") Then halfpennyPrefs.imgPositionClicked.Picture = LoadPicture(resourcePath & "\position-icon-light-600-clicked.jpg")
    If fFExists(resourcePath & "\font-icon-light-600-clicked.jpg") Then halfpennyPrefs.imgFontsClicked.Picture = LoadPicture(resourcePath & "\font-icon-light-600-clicked.jpg")
    If fFExists(resourcePath & "\development-icon-light-600-clicked.jpg") Then halfpennyPrefs.imgDevelopmentClicked.Picture = LoadPicture(resourcePath & "\development-icon-light-600-clicked.jpg")
    If fFExists(resourcePath & "\sounds-icon-light-600-clicked.jpg") Then halfpennyPrefs.imgSoundsClicked.Picture = LoadPicture(resourcePath & "\sounds-icon-light-600-clicked.jpg")
    If fFExists(resourcePath & "\windows-icon-light-600-clicked.jpg") Then halfpennyPrefs.imgWindowClicked.Picture = LoadPicture(resourcePath & "\windows-icon-light-600-clicked.jpg")
    If fFExists(resourcePath & "\about-icon-light-600-clicked.jpg") Then halfpennyPrefs.imgAboutClicked.Picture = LoadPicture(resourcePath & "\about-icon-light-600-clicked.jpg")
...
setIconImagesLight_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure setIconImagesLight of Form halfpennyPrefs"
